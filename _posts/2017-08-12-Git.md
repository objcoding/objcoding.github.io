...
![git](https://raw.githubusercontent.com/zhangchenghuidev/zhangchenghuidev.github.io/master/images/git.png)
...
新建远程分支：`git remote add origin git@github.com:zhangchenghuidev/beegoweb.git`

关联本地分支：`git push --set-upstream origin master`

在 config 文件会出现一下配置：

![config](https://raw.githubusercontent.com/zhangchenghuidev/zhangchenghuidev.github.io/master/images/git2.png)